...
function Widget(src, opaId, isFz59) {
    ...
    // const openWidgetBtn = $('#' + ACTION_ID);
    const openWidgetBtn = $('[id=' + ACTION_ID + ']');
  
    if (openWidgetBtn) {
        openWidgetBtn.on('click', function(e) {
            e.preventDefault();
            console.log('CLICK')
            showWidget();
        })
        ...
        openWidgetBtn.on('touchend', function(e) {
  ...
  Widget("https://pos.gosuslugi.ru/form", 327974)
